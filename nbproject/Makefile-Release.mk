...
${OBJECTDIR}/_ext/7c15c4/array.o: ../source/compiler/array.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/array.o ../source/compiler/array.cpp

${OBJECTDIR}/_ext/7c15c4/ast.o: ../source/compiler/ast.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/ast.o ../source/compiler/ast.cpp

${OBJECTDIR}/_ext/7c15c4/codegen.o: ../source/compiler/codegen.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/codegen.o ../source/compiler/codegen.cpp

${OBJECTDIR}/_ext/7c15c4/entry.o: ../source/compiler/entry.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/entry.o ../source/compiler/entry.cpp

${OBJECTDIR}/_ext/7c15c4/errors.o: ../source/compiler/errors.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/errors.o ../source/compiler/errors.cpp

${OBJECTDIR}/_ext/7c15c4/function_table.o: ../source/compiler/function_table.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/function_table.o ../source/compiler/function_table.cpp

${OBJECTDIR}/_ext/7c15c4/id_table.o: ../source/compiler/id_table.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/id_table.o ../source/compiler/id_table.cpp

${OBJECTDIR}/_ext/7c15c4/io.o: ../source/compiler/io.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/io.o ../source/compiler/io.cpp

${OBJECTDIR}/_ext/7c15c4/lexer.o: ../source/compiler/lexer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/lexer.o ../source/compiler/lexer.cpp

${OBJECTDIR}/_ext/7c15c4/memory.o: ../source/compiler/memory.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/memory.o ../source/compiler/memory.cpp

${OBJECTDIR}/_ext/7c15c4/parser.o: ../source/compiler/parser.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/parser.o ../source/compiler/parser.cpp

${OBJECTDIR}/_ext/7c15c4/signature_table.o: ../source/compiler/signature_table.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/signature_table.o ../source/compiler/signature_table.cpp

${OBJECTDIR}/_ext/7c15c4/string_buffer.o: ../source/compiler/string_buffer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7c15c4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7c15c4/string_buffer.o ../source/compiler/string_buffer.cpp

${OBJECTDIR}/_ext/9fad6e13/database.o: ../source/runtime/database.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9fad6e13
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9fad6e13/database.o ../source/runtime/database.cpp

${OBJECTDIR}/_ext/9fad6e13/memory.o: ../source/runtime/memory.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9fad6e13
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9fad6e13/memory.o ../source/runtime/memory.cpp

${OBJECTDIR}/_ext/9fad6e13/planning.o: ../source/runtime/planning.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/9fad6e13
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9fad6e13/planning.o ../source/runtime/planning.cpp
